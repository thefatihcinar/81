...
public class Game extends AppCompatActivity {
    ...
    private void InitializeEverytingInTheGame(){
        ...
        InitializeTheBackgroundMusic(); // determine what to play
        mediaPlayerBackgroundMusic.start(); // and play it
        ...
        refSorular.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                isConnected = true;
                // now the connection is satisfied
    ...
    private void UpdateTheButtons(){
        ...
        for(int i = 0 ; i < 4; i++){
            ...
            buttons[i].setBackgroundColor(getResources().getColor(R.color.newAwesomeRed));
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                if(givenAnswer == RightAnswer){
                    ...
                    touchedButton.setBackgroundColor(getResources().getColor(R.color.wrongAnswerGray));
    ...
    private void GameOver(){
        /*
            This method is responsile for finishing the game
            GAME OVER CASE
         */
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                mediaPlayer.release();
                // after hearing the game over sound, release the media player
            }
        }, 2500);
    ...
    */
    ...
    private void InitializeSorularBeforeConnection(){
        ...
        tempResim = "https://firebasestorage.googleapis.com/v0/b/seksen-bir.appspot.com/o/part0%2Fagri-1.jpg?alt=media&token=f868d140-e337-4286-947b-611922687bd6";
        tempSehir = "Ağrı";
        iterator = new Soru(tempResim, tempSehir);
        Sorular.add(iterator);

        tempResim = "https://firebasestorage.googleapis.com/v0/b/seksen-bir.appspot.com/o/part0%2Fantalya-1.jpg?alt=media&token=3800a07f-c504-433a-8843-d2499ade1ba3";
        tempSehir = "Antalya";
        iterator = new Soru(tempResim, tempSehir);
        Sorular.add(iterator);

        tempResim = "https://firebasestorage.googleapis.com/v0/b/seksen-bir.appspot.com/o/part0%2Fgiresun-1.jpg?alt=media&token=9a2a6196-e7ea-4bf8-825d-629db44eefb1";
        tempSehir = "Giresun";
        iterator = new Soru(tempResim, tempSehir);
        Sorular.add(iterator);


        tempResim = "https://firebasestorage.googleapis.com/v0/b/seksen-bir.appspot.com/o/part0%2Fkayseri-1.jpg?alt=media&token=4ae53b83-1ac6-410a-a074-f20dff62bb95";
        tempSehir = "Kayseri";
        iterator = new Soru(tempResim, tempSehir);
        Sorular.add(iterator);

        tempResim = "https://firebasestorage.googleapis.com/v0/b/seksen-bir.appspot.com/o/part0%2Fmugla-1.jpg?alt=media&token=aa8db304-4966-48c7-9105-02893f848481";
        tempSehir = "Muğla";
        iterator = new Soru(tempResim, tempSehir);
        Sorular.add(iterator);

        tempResim = "https://firebasestorage.googleapis.com/v0/b/seksen-bir.appspot.com/o/part0%2Fsinop-1.jpg?alt=media&token=7d5e94ac-c0a4-41c7-a3c5-2708534bdf09";
        tempSehir = "Sinop";
        iterator = new Soru(tempResim, tempSehir);
        Sorular.add(iterator);
    ...
    private void InitializeTheBackgroundMusic(){
        /*
            This method randomly determines a background music
            and plays it
         */

        Random rand = new Random();

        int randomMusic = rand.nextInt(4);

        switch(randomMusic){
            case 0:
                mediaPlayerBackgroundMusic = MediaPlayer.create(Game.this,R.raw.background_genclik_marsi);
                break;
            case 1:
                mediaPlayerBackgroundMusic = MediaPlayer.create(Game.this,R.raw.background_istiklal_marsi);
                break;
            case 2:
                mediaPlayerBackgroundMusic = MediaPlayer.create(Game.this,R.raw.background_izmir_marsi);
                break;
            case 3:
                mediaPlayerBackgroundMusic = MediaPlayer.create(Game.this,R.raw.background_mehter);
                break;
